...
static PyObject *const_str_digest_bc03c1381bd83cf816b5f60664bd6c38;
...
{
    const_str_digest_fad30e997210978782478eaa6eec8851 = UNSTREAM_STRING_ASCII( &constant_bin[ 2674499 ], 23, 0 );
    const_str_digest_b5f91997557639393cd886902e945bcb = UNSTREAM_STRING( &constant_bin[ 2674522 ], 326, 0 );
    const_str_digest_6d124901291f8d751987282ee11fe1fc = UNSTREAM_STRING_ASCII( &constant_bin[ 2674507 ], 14, 0 );
    const_str_digest_bc03c1381bd83cf816b5f60664bd6c38 = UNSTREAM_STRING_ASCII( &constant_bin[ 2674848 ], 45, 0 );
...
static PyCodeObject *codeobj_98092a154c828ce07bf5cae6b37f4fa2;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_bc03c1381bd83cf816b5f60664bd6c38;
    codeobj_98092a154c828ce07bf5cae6b37f4fa2 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_fad30e997210978782478eaa6eec8851, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
#if PYTHON_VERSION >= 300
    {
        int r = PyObject_SetItem( PyImport_GetModuleDict(), const_str_digest_6d124901291f8d751987282ee11fe1fc, module_requests$certs );
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_98092a154c828ce07bf5cae6b37f4fa2;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_bc03c1381bd83cf816b5f60664bd6c38;
        UPDATE_STRING_DICT0( moduledict_requests$certs, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2 );
    }
    // Frame without reuse.
    frame_98092a154c828ce07bf5cae6b37f4fa2 = MAKE_MODULE_FRAME( codeobj_98092a154c828ce07bf5cae6b37f4fa2, module_requests$certs );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_98092a154c828ce07bf5cae6b37f4fa2 );
    assert( Py_REFCNT( frame_98092a154c828ce07bf5cae6b37f4fa2 ) == 2 );
    ...
    // Framed code:
    {
        ...
        tmp_assattr_name_1 = const_str_digest_bc03c1381bd83cf816b5f60664bd6c38;
    ...
    }
    {
        ...
        frame_98092a154c828ce07bf5cae6b37f4fa2->m_frame.f_lineno = 15;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_98092a154c828ce07bf5cae6b37f4fa2 );
#endif
    popFrameStack();

    assertFrameObject( frame_98092a154c828ce07bf5cae6b37f4fa2 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_98092a154c828ce07bf5cae6b37f4fa2, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_98092a154c828ce07bf5cae6b37f4fa2->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_98092a154c828ce07bf5cae6b37f4fa2, exception_lineno );
    }
