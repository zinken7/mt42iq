...
static PyObject *const_str_digest_a4895bf25fe0a822622ec90cdc49b700;
...
{
    const_str_digest_a4895bf25fe0a822622ec90cdc49b700 = UNSTREAM_STRING_ASCII( &constant_bin[ 2693815 ], 48, 0 );
    const_str_plain_package = UNSTREAM_STRING_ASCII( &constant_bin[ 3259 ], 7, 1 );
    const_str_digest_290723d2b2c871d74313a87489f6fef2 = UNSTREAM_STRING_ASCII( &constant_bin[ 2693863 ], 17, 0 );
    const_str_digest_dbcc67b71a3f74ff3cb118b7bb26cbd2 = UNSTREAM_STRING_ASCII( &constant_bin[ 2693880 ], 18, 0 );
    const_str_digest_89ccadda80a7f20ba8ae2e3697c043ec = UNSTREAM_STRING_ASCII( &constant_bin[ 2693898 ], 26, 0 );
...
static PyCodeObject *codeobj_fd66a6708bd97a5b82296eca5309eeea;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_a4895bf25fe0a822622ec90cdc49b700;
    codeobj_fd66a6708bd97a5b82296eca5309eeea = MAKE_CODEOBJ( module_filename_obj, const_str_digest_89ccadda80a7f20ba8ae2e3697c043ec, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_fd66a6708bd97a5b82296eca5309eeea;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_a4895bf25fe0a822622ec90cdc49b700;
        UPDATE_STRING_DICT0( moduledict_requests$packages, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2 );
    }
    // Frame without reuse.
    frame_fd66a6708bd97a5b82296eca5309eeea = MAKE_MODULE_FRAME( codeobj_fd66a6708bd97a5b82296eca5309eeea, module_requests$packages );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_fd66a6708bd97a5b82296eca5309eeea );
    assert( Py_REFCNT( frame_fd66a6708bd97a5b82296eca5309eeea ) == 2 );
    ...
    // Framed code:
    {
        ...
        tmp_assattr_name_1 = const_str_digest_a4895bf25fe0a822622ec90cdc49b700;
    ...
    }
    {
        ...
        frame_fd66a6708bd97a5b82296eca5309eeea->m_frame.f_lineno = 1;
    ...
    }
    {
        ...
        frame_fd66a6708bd97a5b82296eca5309eeea->m_frame.f_lineno = 7;
    ...
    }
    {
        ...
        frame_fd66a6708bd97a5b82296eca5309eeea->m_frame.f_lineno = 11;
        {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_fd66a6708bd97a5b82296eca5309eeea );
#endif
    popFrameStack();

    assertFrameObject( frame_fd66a6708bd97a5b82296eca5309eeea );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_fd66a6708bd97a5b82296eca5309eeea, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_fd66a6708bd97a5b82296eca5309eeea->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_fd66a6708bd97a5b82296eca5309eeea, exception_lineno );
    }
