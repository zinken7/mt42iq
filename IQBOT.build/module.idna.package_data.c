...
static PyObject *const_str_digest_b4b3b24bad489679807a3daf908192b4;
...
{
    const_str_digest_3054b5ec22f6f3e39a016efbfb80bac6 = UNSTREAM_STRING_ASCII( &constant_bin[ 491297 ], 17, 0 );
    const_str_digest_b4b3b24bad489679807a3daf908192b4 = UNSTREAM_STRING_ASCII( &constant_bin[ 491314 ], 48, 0 );
    const_str_digest_3354be1800dd49d2d19ddb29a356eeb3 = UNSTREAM_STRING_ASCII( &constant_bin[ 491362 ], 3, 0 );
    const_str_digest_d4e6cc9d2237ec84bb1df833ff001a94 = UNSTREAM_STRING_ASCII( &constant_bin[ 491365 ], 26, 0 );
...
static PyCodeObject *codeobj_3082d49f5cb7f28d39f4d43c61612ba2;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_b4b3b24bad489679807a3daf908192b4;
    codeobj_3082d49f5cb7f28d39f4d43c61612ba2 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_d4e6cc9d2237ec84bb1df833ff001a94, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_3082d49f5cb7f28d39f4d43c61612ba2;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_b4b3b24bad489679807a3daf908192b4;
        UPDATE_STRING_DICT0( moduledict_idna$package_data, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2 );
    }
    // Frame without reuse.
    frame_3082d49f5cb7f28d39f4d43c61612ba2 = MAKE_MODULE_FRAME( codeobj_3082d49f5cb7f28d39f4d43c61612ba2, module_idna$package_data );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_3082d49f5cb7f28d39f4d43c61612ba2 );
    assert( Py_REFCNT( frame_3082d49f5cb7f28d39f4d43c61612ba2 ) == 2 );
    ...
    // Framed code:
    {
        ...
        tmp_assattr_name_1 = const_str_digest_b4b3b24bad489679807a3daf908192b4;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_3082d49f5cb7f28d39f4d43c61612ba2 );
#endif
    popFrameStack();

    assertFrameObject( frame_3082d49f5cb7f28d39f4d43c61612ba2 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_3082d49f5cb7f28d39f4d43c61612ba2, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_3082d49f5cb7f28d39f4d43c61612ba2->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_3082d49f5cb7f28d39f4d43c61612ba2, exception_lineno );
    }
